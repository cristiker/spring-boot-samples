package com.cristik.elasticsearch.wrapper;

import com.cristik.elasticsearch.utils.ElasticSearchUtil;
...
public class EsSearchWrapper {
    ...
    public static EsSearchWrapper of(String esUrl) {
        return of(ElasticSearchUtil.createRestHighLevelClient(esUrl));
    }
    ...
    public static EsSearchWrapper of(String esIp, Integer esPort) {
        return of(ElasticSearchUtil.createRestHighLevelClient(esIp, esPort));
    }
