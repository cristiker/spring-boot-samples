...
public class SensitiveWordUtil2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        result = SensitiveWordUtil2.contains(string, SensitiveWordUtil2.MinMatchTYpe);
        System.out.println(result);

        //获取语句中的敏感词
        Set<String> set = SensitiveWordUtil2.getSensitiveWord(string);
        System.out.println("语句中包含敏感词的个数为：" + set.size() + "。包含：" + set);
        set = SensitiveWordUtil2.getSensitiveWord(string, SensitiveWordUtil2.MinMatchTYpe);
        System.out.println("语句中包含敏感词的个数为：" + set.size() + "。包含：" + set);

        //替换语句中的敏感词
        String filterStr = SensitiveWordUtil2.replaceSensitiveWord(string, '*');
        System.out.println(filterStr);
        filterStr = SensitiveWordUtil2.replaceSensitiveWord(string, '*', SensitiveWordUtil2.MinMatchTYpe);
        System.out.println(filterStr);

        String filterStr2 = SensitiveWordUtil2.replaceSensitiveWord(string, "[*敏感词*]");
        System.out.println(filterStr2);
        filterStr2 = SensitiveWordUtil2.replaceSensitiveWord(string, "[*敏感词*]", SensitiveWordUtil2.MinMatchTYpe);
        System.out.println(filterStr2);
    }
}
